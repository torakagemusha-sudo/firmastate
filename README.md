...
Most workflow and state tools split the truth across diagrams, handwritten code, runtime behavior, and undocumented side effects.
...
- **Machine as authority** — the state machine model is the source of truth
- **Multiple synchronized views** — graph, DSL, simulation, and export derive from the same machine
- **Governed execution** — effects require explicit authority
- **Deterministic compilation** — identical machines should produce identical outputs
- **Inspectable systems** — validation, traces, and constraints are first-class
